...
/*
지금 자석하는 부분의 경우 github에 완전판이 올라가기 때문에
...
자식 클래스의 객체를 생성 시 필수적으로 부모 클래스의 생성자를 호출하기 때문입니다.
자식 클래스에서 정의되지 않은 일부 필드와 메서드를 어떻게 사용할 수 있냐면 부모 클래스의 객체를 생성한 다음에 자식
클래스에서 고유 필드와 함수를 더하여 합치는 과정을 거치기 때문입니다.
